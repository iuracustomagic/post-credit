            ...
            <div class="container-fluid ml-4 ">
                ...
                <div class="row mt-4 ">
                    <form action="{{route('division.store')}}" method="post" class="w-75" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="form-group col-sm-4 mr-4">
                            <select class="custom-select form-control ml-2" name="rate_id" id="exampleSelectBorder" >
                            ...
                            <div class="form-group col-sm-4 d-flex">
                                <select class="custom-select form-control ml-2" name="type" id="exampleSelectBorder" >
