            ...
            <div class="container-fluid">
                <form action="" method="GET" class="py-3">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select name="division" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="0" tabindex="-1" aria-hidden="true">
                                <option value="">Адрес Торговой точки</option>
                                @foreach($divisions as $division)
                                    <option data-select2-id="{{$division->id}}" value="{{$division->id}}">{{$division->address}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="col-md-3">
